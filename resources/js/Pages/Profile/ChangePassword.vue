...
function submit() {
    form.put(route('user.profile.change-password.update'));
}
</script>

<template>
    <UserLayout>
        <Head title="Ubah Password - KPM SMART" />

        <template #header-title>Ubah Password</template>
        <template #header-sub>Perbarui password akun Anda untuk keamanan</template>
