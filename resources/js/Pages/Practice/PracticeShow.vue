...
<template>
    <UserLayout>
        <Head title="Detail Riwayat - KPM Belajar Online" />
        ...
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <Card class="p-5">
                <div class="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center">
                    ...
                    <div v-if="showScore"><p class="text-xs text-muted-foreground">Skor</p><p class="text-2xl font-bold text-primary">{{ session.total_score?.toFixed(1) }}</p></div>
