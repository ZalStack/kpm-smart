    ...
    <UserLayout>
        ...
        <div v-else class="space-y-6">
            ...
            <div class="text-center anim-stats-fade">
                <Link :href="route('user.practice.history')" class="inline-flex items-center gap-2 text-sm font-medium text-primary hover:text-primary/70 transition-all duration-300 hover:gap-3 group">
