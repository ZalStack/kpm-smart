                ...
                <div class="bg-card rounded-2xl border border-border/60 shadow-sm overflow-hidden mb-6 anim-fade-in-up anim-delay-1">
                    ...
                    <div class="p-5 sm:p-6 space-y-4">
                        <div class="space-y-2">
                            ...
                            <Input v-model="form.name" required placeholder="Masukkan nama lengkap" class="h-11 rounded-xl" />
                        ...
                        <div class="space-y-2">
                            ...
                            <Input v-model="form.email" type="email" required placeholder="email@contoh.com" class="h-11 rounded-xl" />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <Input v-model="form.password" type="password" required minlength="8" placeholder="Minimal 8 karakter" class="h-11 rounded-xl" />
                            ...
                            <div class="space-y-2">
                                ...
                                <Input v-model="form.password_confirmation" type="password" required placeholder="Ulangi password" class="h-11 rounded-xl" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-5 sm:p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <Input v-model="form.student_class" placeholder="Contoh: X IPA 1" class="h-11 rounded-xl" />
                            </div>
                            <div class="space-y-2">
                                <Label class="text-sm font-semibold">Bidang</Label>
                                <Input v-model="form.bidang" placeholder="Contoh: Matematika" class="h-11 rounded-xl" />
                            </div>
                            <div class="space-y-2">
                                <Label class="text-sm font-semibold">Level</Label>
                                <Input v-model="form.level" placeholder="Contoh: Pemula" class="h-11 rounded-xl" />
                            </div>
                            <div class="space-y-2">
                                <Label class="text-sm font-semibold">Sekolah</Label>
                                <Input v-model="form.school_name" placeholder="Nama sekolah" class="h-11 rounded-xl" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-5 sm:p-6 space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <Input v-model="form.phone" placeholder="08xxx" class="h-11 rounded-xl" />
                            </div>
                            <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <Textarea v-model="form.address" :rows="2" placeholder="Alamat lengkap" class="resize-none rounded-xl" />
                        </div>
                    </div>
                </div>
