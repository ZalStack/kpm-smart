...
<template>
    <AdminLayout>
        ...
        <Link :href="route('admin.users.show', user.id)" class="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition mb-6">
                ...
                <form @submit.prevent="submit" enctype="multipart/form-data">
                    ...
                    <div class="p-6 border-b flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-muted-foreground mt-1">Kosongkan jika tidak diubah.</p>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-b">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-2"><Label>Kelas</Label><Input v-model="form.student_class" /></div>
                            <div class="space-y-2"><Label>Bidang</Label><Input v-model="form.bidang" /></div>
                            <div class="space-y-2"><Label>Level</Label><Input v-model="form.level" /></div>
                            <div class="space-y-2"><Label>Sekolah</Label><Input v-model="form.school_name" /></div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-b">
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="space-y-2"><Label>No. HP/WA</Label><Input v-model="form.phone" /></div>
                                <div class="space-y-2"><Label>Jenis Kelamin</Label><Select v-model="form.gender"><option value="">Pilih</option><option value="Laki-laki">Laki-laki</option><option value="Perempuan">Perempuan</option></Select></div>
                            </div>
                            <div class="space-y-2"><Label>Agama</Label><Select v-model="form.religion"><option value="">Pilih</option><option value="Islam">Islam</option><option value="Kristen">Kristen</option><option value="Katolik">Katolik</option><option value="Hindu">Hindu</option><option value="Buddha">Buddha</option><option value="Konghucu">Konghucu</option></Select></div>
                            <div class="space-y-2"><Label>Alamat</Label><Textarea v-model="form.address" :rows="2" /></div>
                        </div>
                    </div>
