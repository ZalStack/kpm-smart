...
<template>
    <UserLayout>
        ...
        <div class="anim-fade-in-up anim-delay-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            <Link :href="route('user.packages.index')" class="group rounded-2xl border bg-card p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            <Link :href="route('user.practice.history')" class="group rounded-2xl border bg-card p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            <Link :href="route('user.leaderboard')" class="group rounded-2xl border bg-card p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
