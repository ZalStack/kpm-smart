...
<template>
    <UserLayout>
        ...
        <!-- Welcome Banner -->
        <div class="anim-fade-in-up rounded-2xl bg-gradient-to-r from-fern to-hunter-green p-6 md:p-8 text-white mb-8 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-white/80 text-sm md:text-base max-w-lg">Selamat datang di KPM SMART. Pilih soal tugas dan mulai berlatih sekarang.</p>
        ...
        <!-- Gamification Widget -->
        <div class="anim-fade-in-up anim-delay-1 grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <!-- Level & XP Card -->
            ...
            <div class="rounded-2xl border bg-card p-5 shadow-card">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold">{{ g.streak?.current || 0 }} <span class="text-xs font-normal text-muted-foreground">hari</span></p>
                    </div>
                </div>
            ...
            <div class="rounded-2xl border bg-card p-5 shadow-card">
                ...
                <div class="grid grid-cols-2 gap-2 text-xs">
                    <div class="bg-muted/30 rounded-lg px-2.5 py-1.5">
        ...
        <!-- Stats -->
        <div class="anim-fade-in-up anim-delay-2 grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <!-- Quick Actions -->
        <div class="anim-fade-in-up anim-delay-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link :href="route('packages.index')" class="group rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5">
                <div class="w-10 h-10 rounded-lg bg-fern/10 flex items-center justify-center text-fern mb-3 group-hover:scale-110 transition">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                </div>
                <h3 class="font-semibold mb-1">Soal Tugas</h3>
                <p class="text-sm text-muted-foreground">Lihat dan pilih soal tugas</p>
            </Link>
            <Link :href="route('practice.history')" class="group rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5">
                <div class="w-10 h-10 rounded-lg bg-pine-teal/10 flex items-center justify-center text-pine-teal mb-3 group-hover:scale-110 transition">
                ...
                <h3 class="font-semibold mb-1">Riwayat Tugas</h3>
                <p class="text-sm text-muted-foreground">Lihat riwayat pengerjaan</p>
            </Link>
            <Link :href="route('analytics')" class="group rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5">
                <div class="w-10 h-10 rounded-lg bg-dry-sage/10 flex items-center justify-center text-dry-sage mb-3 group-hover:scale-110 transition">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z"/></svg>
                </div>
                <h3 class="font-semibold mb-1">Analitik</h3>
                <p class="text-sm text-muted-foreground">Grafik progres belajar</p>
            </Link>
            <Link :href="route('leaderboard')" class="group rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5">
                <div class="w-10 h-10 rounded-lg bg-amber-50 flex items-center justify-center text-amber-600 mb-3 group-hover:scale-110 transition">
                ...
                <h3 class="font-semibold mb-1">Papan Peringkat</h3>
                <p class="text-sm text-muted-foreground">Lihat peringkatmu</p>
            </Link>
        </div>
    </UserLayout>
</template>
