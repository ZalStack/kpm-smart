...
<template>
    <UserLayout>
        ...
        <!-- Welcome Banner -->
        <div class="rounded-xl bg-gradient-to-r from-fern to-hunter-green p-6 md:p-8 text-white mb-8 relative overflow-hidden">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <StatCard title="Paket Aktif" :value="packages.length" color="hunter-green" icon="<svg class='w-5 h-5' fill='none' viewBox='0 0 24 24' stroke='currentColor' stroke-width='2'><path stroke-linecap='round' stroke-linejoin='round' d='M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'/></svg>" />
        </div>

        <!-- Quick Actions -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link :href="route('packages.index')" class="group rounded-xl border bg-card p-6 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5">
                ...
                <h3 class="font-semibold mb-1">Paket Tugas</h3>
                <p class="text-sm text-muted-foreground">Lihat dan pilih paket tugas yang tersedia</p>
            </Link>
            <Link :href="route('practice.history')" class="group rounded-xl border bg-card p-6 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5">
                ...
                <p class="text-sm text-muted-foreground">Lihat riwayat pengerjaan tugas</p>
            </Link>
            <Link :href="route('practice.statistics')" class="group rounded-xl border bg-card p-6 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5">
                ...
                <p class="text-sm text-muted-foreground">Lihat statistik performa belajar</p>
            </Link>
        </div>
    </UserLayout>
</template>
