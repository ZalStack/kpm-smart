                    ...
                    <div class="hidden md:flex items-center gap-1">
                        <template v-if="user">
                            <template v-if="user.role === 'user'">
                                ...
                                <Link :href="route('analytics')" class="inline-flex items-center px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent rounded-md transition" :class="{ 'text-foreground bg-accent': route().current('analytics') }">Analitik</Link>
                                <Link :href="route('leaderboard')" class="inline-flex items-center px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent rounded-md transition" :class="{ 'text-foreground bg-accent': route().current('leaderboard') }">Peringkat</Link>
                    ...
                    <div class="px-4 py-3 space-y-1">
                        <template v-if="user">
                            ...
                            <template v-if="user.role === 'user'">
                                ...
                                <Link :href="route('analytics')" @click="closeMobileMenu" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-accent transition text-sm" :class="route().current('analytics') ? 'bg-accent text-foreground' : 'text-muted-foreground'">Analitik</Link>
                                <Link :href="route('leaderboard')" @click="closeMobileMenu" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-accent transition text-sm" :class="route().current('leaderboard') ? 'bg-accent text-foreground' : 'text-muted-foreground'">Peringkat</Link>
