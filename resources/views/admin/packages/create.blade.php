        ...
        <form action="{{ route('admin.packages.store') }}" method="POST" enctype="multipart/form-data" id="packageForm">
                ...
                <div class="space-y-4">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="4" required
                                  class="form-input"
                                  placeholder="Deskripsi paket secara lengkap">{{ old('description') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jenjang" value="{{ old('jenjang') }}"
                                   class="form-input"
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                            <div class="flex-1 w-full">
                                <input type="file" id="thumbnailInput" name="thumbnail" accept="image/*"
                                       class="form-input file:mr-3 file:py-1.5 file:px-4 file:rounded-md file:border-0 file:bg-primary/10 file:text-primary file:text-xs file:font-semibold file:cursor-pointer">
            ...
            <div class="p-4 sm:p-6 border-b border-border bg-muted/30">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <h3 class="text-base font-bold text-navy">Harga &amp; Diskon</h3>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="form-group">
                        <label class="form-label">Harga Normal (Rp) <span class="text-danger-500">*</span></label>
                        <input type="number" id="priceInput" name="price" value="{{ old('price') }}" required min="0" step="1"
                               class="form-input"
                               placeholder="0">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="discountPriceInput" name="discount_price" value="{{ old('discount_price') }}" min="0" step="1" disabled
                ...
                <div class="flex items-center justify-between mt-4 p-4 bg-card rounded-md border border-border">
                    <div>
                        <label for="discountToggle" class="text-sm font-medium text-foreground cursor-pointer">🏷️ Aktifkan Diskon</label>
                    ...
                    <label class="relative inline-flex items-center cursor-pointer flex-shrink-0">
                        <input type="checkbox" id="discountToggle" name="is_discount_active" value="1"
                               {{ old('is_discount_active') ? 'checked' : '' }} class="sr-only peer">
                        <div class="w-11 h-6 bg-muted rounded-full peer peer-checked:bg-danger-500 transition-colors duration-300"></div>
                ...
                <div id="discountPreview" class="hidden mt-3 text-xs md:text-sm text-success-500 font-medium bg-success-50 border border-success-200 rounded-xl px-4 py-2.5"></div>
            </div>
            ...
            <div class="p-4 sm:p-6 border-b border-border bg-muted/30">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <h3 class="text-base font-bold text-navy">Masa Berlaku Membership</h3>
                </div>
                ...
                <div class="sm:w-72">
                    <div class="form-group">
                        ...
                        <input type="number" id="membershipDurationInput" name="membership_duration_days"
                               value="{{ old('membership_duration_days', 30) }}" required min="1" step="1"
                               class="form-input">
            ...
            <div class="p-4 sm:p-6 border-b border-border">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <h3 class="text-base font-bold text-navy">Pengaturan Latihan</h3>
                </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between p-4 bg-muted/50 rounded-md border border-border">
                        <div>
                            <label for="hideExplanationToggle" class="text-sm font-medium text-foreground cursor-pointer">Sembunyikan Pembahasan</label>
                        ...
                        <label class="relative inline-flex items-center cursor-pointer flex-shrink-0">
                            <input type="checkbox" id="hideExplanationToggle" name="hide_explanation" value="1"
                                   {{ old('hide_explanation') ? 'checked' : '' }} class="sr-only peer">
                            <div class="w-11 h-6 bg-muted rounded-full peer peer-checked:bg-danger-500 transition-colors duration-300"></div>
                            <div class="absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform duration-300 peer-checked:translate-x-5"></div>
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="timeLimitInput" name="time_limit_minutes"
                               value="{{ old('time_limit_minutes', 0) }}" min="0" max="480" step="1"
            ...
            <div class="p-4 sm:p-6 border-b border-border">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <h3 class="text-base font-bold text-navy">Bayar Seikhlasnya</h3>
                </div>

                <div class="flex items-center justify-between p-4 bg-muted/50 rounded-md border border-border">
                    <div>
                        <label for="pwywToggle" class="text-sm font-medium text-foreground cursor-pointer">Izinkan User Bayar Nominal Sendiri</label>
                    ...
                    <label class="relative inline-flex items-center cursor-pointer flex-shrink-0">
                        <input type="checkbox" id="pwywToggle" name="is_pay_what_you_want" value="1"
                               {{ old('is_pay_what_you_want') ? 'checked' : '' }} class="sr-only peer">
                ...
                <div id="pwywFields" class="mt-4 hidden">
                    <div class="form-group">
                        ...
                        <input type="number" name="min_pay_amount" value="{{ old('min_pay_amount', 0) }}" min="0" step="1"
