            ...
            <div class="flex items-start gap-4">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <div class="flex flex-wrap gap-2 mt-3">
                        ...
                        @endif
                        @if($package->bidang)
                            <span class="inline-flex items-center gap-1.5 text-[11px] font-semibold px-3 py-1 rounded-full bg-primary/10 text-primary">📂 {{ $package->bidang }}</span>
                        @endif
                        @if($package->level)
                            <span class="inline-flex items-center gap-1.5 text-[11px] font-semibold px-3 py-1 rounded-full bg-navy/10 text-foreground">🎯 {{ $package->level }}</span>
                        @endif
