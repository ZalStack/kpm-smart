    ...
    <aside id="sidebar"
        ...
        <nav class="relative px-3 py-4 flex-1 min-h-0 overflow-y-auto sidebar-scroll">
            ...
            <a href="{{ route('admin.videos.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-md transition-all duration-200 mb-0.5 {{ request()->routeIs('admin.videos.*', 'admin.video-orders.*') ? 'nav-active' : 'text-white/55 hover:bg-white/5 hover:text-white' }}">
                <div class="w-8 h-8 rounded-md {{ request()->routeIs('admin.videos.*', 'admin.video-orders.*') ? 'bg-white/10' : 'bg-white/5' }} flex items-center justify-center text-sm flex-shrink-0 transition-colors">
                ...
                <span class="text-[13px] font-medium">Video Pembahasan</span>
                @php $pendingVideoOrders = \App\Models\VideoOrder::where('payment_status', 'paid')->where('access_granted', false)->count(); @endphp
                @if ($pendingVideoOrders > 0)
                    <span class="ml-auto bg-destructive text-destructive-foreground text-[10px] font-bold px-2 py-0.5 rounded-md min-w-[20px] text-center animate-pulse-soft">{{ $pendingVideoOrders }}</span>
                @endif
            </a>

            <a href="{{ route('admin.orders.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-md transition-all duration-200 mb-0.5 {{ request()->routeIs('admin.orders.*') ? 'nav-active' : 'text-white/55 hover:bg-white/5 hover:text-white' }}">
                <div class="w-8 h-8 rounded-md {{ request()->routeIs('admin.orders.*') ? 'bg-white/10' : 'bg-white/5' }} flex items-center justify-center text-sm flex-shrink-0 transition-colors">
                ...
                @if ($pendingOrders > 0)
                    <span class="ml-auto bg-destructive text-destructive-foreground text-[10px] font-bold px-2 py-0.5 rounded-md min-w-[20px] text-center animate-pulse-soft">{{ $pendingOrders }}</span>
                @endif
            </a>
            ...
            <a href="{{ route('admin.enroll-keys.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-md transition-all duration-200 mb-0.5 {{ request()->routeIs('admin.enroll-keys.*') ? 'nav-active' : 'text-white/55 hover:bg-white/5 hover:text-white' }}">
                <div class="w-8 h-8 rounded-md {{ request()->routeIs('admin.enroll-keys.*') ? 'bg-white/10' : 'bg-white/5' }} flex items-center justify-center text-sm flex-shrink-0 transition-colors">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z"/></svg>
                </div>
                <span class="text-[13px] font-medium">Enroll Keys</span>
                @php $pendingEnroll = \App\Models\Order::where('payment_status', 'paid')->whereJsonContains('enrollment->activated', false)->count(); @endphp
                @if ($pendingEnroll > 0)
                    <span class="ml-auto bg-destructive text-destructive-foreground text-[10px] font-bold px-2 py-0.5 rounded-md min-w-[20px] text-center animate-pulse-soft">{{ $pendingEnroll }}</span>
                @endif
            </a>

            <a href="{{ route('admin.transactions.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-md transition-all duration-200 mb-0.5 {{ request()->routeIs('admin.transactions.*') ? 'nav-active' : 'text-white/55 hover:bg-white/5 hover:text-white' }}">
                <div class="w-8 h-8 rounded-md {{ request()->routeIs('admin.transactions.*') ? 'bg-white/10' : 'bg-white/5' }} flex items-center justify-center text-sm flex-shrink-0 transition-colors">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z"/></svg>
                </div>
                <span class="text-[13px] font-medium">Transaksi</span>
            </a>

            <a href="{{ route('admin.reports.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-md transition-all duration-200 mb-0.5 {{ request()->routeIs('admin.reports.*') ? 'nav-active' : 'text-white/55 hover:bg-white/5 hover:text-white' }}">
                <div class="w-8 h-8 rounded-md {{ request()->routeIs('admin.reports.*') ? 'bg-white/10' : 'bg-white/5' }} flex items-center justify-center text-sm flex-shrink-0 transition-colors">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z"/></svg>
                </div>
                <span class="text-[13px] font-medium">Laporan</span>
            </a>
            ...
            <a href="{{ route('admin.testimonials.index') }}"
                class="flex items-center gap-3 px-3 py-2 rounded-md transition-all duration-200 mb-0.5 {{ request()->routeIs('admin.testimonials.*') ? 'nav-active' : 'text-white/55 hover:bg-white/5 hover:text-white' }}">
                <div class="w-8 h-8 rounded-md {{ request()->routeIs('admin.testimonials.*') ? 'bg-white/10' : 'bg-white/5' }} flex items-center justify-center text-sm flex-shrink-0 transition-colors">
                ...
                @php $pendingTestimonials = \App\Models\Testimonial::where('is_approved', false)->count(); @endphp
                @if ($pendingTestimonials > 0)
                    <span class="ml-auto bg-destructive text-destructive-foreground text-[10px] font-bold px-2 py-0.5 rounded-md min-w-[20px] text-center animate-pulse-soft">{{ $pendingTestimonials }}</span>
                @endif
            </a>
        ...
        <div id="mobileBottomNav" class="lg:hidden fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur border-t z-30 px-2 py-1 safe-area-bottom">
            <div class="flex items-center justify-around">
                ...
                <a href="{{ route('admin.transactions.index') }}" class="mobile-nav-item {{ request()->routeIs('admin.transactions.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z"/></svg>
                    <span class="text-[10px] font-medium">Pembayaran</span>
                </a>
